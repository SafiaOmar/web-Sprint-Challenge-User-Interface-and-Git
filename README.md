...
Answer: A semantic element clearly describes its meaning to both the browser and the developer. Example <p>

2. Name two big differences between `display: block;` and `display: inline;`.

Answer: Inline elements respect left & right margins and padding, but not top & bottom cannot have a width and height set
...
3. What are the 4 areas of the box model?
   Answer: the content edge, padding edge, border edge, and margin edge
